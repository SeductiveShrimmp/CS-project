...
int arr[4][4] = { {0} }, c[4], temp = 0, len = 0, score = 0, 
    highscore = 0, count = 0, 
    ch = 0; // count to count the number of turns 
  
int findlength(int n); 
  
// Function printing the game of board
void print() 
{ 
    int k, len1; 
